              ...
              @if (loading()) {
                ...
                @for (item of ingredientes(); track item._id || item.id) {
                  <tr class="hover:bg-muted/30 transition-colors border-b border-border group">
                    ...
                    <td class="p-4 text-center">
                      <button (click)="editar(item)" class="text-neutral-500 hover:text-blue-500 hover:bg-blue-500/10 p-2 rounded transition-colors mr-2" title="Editar ingrediente">
                      ...
                      <button (click)="eliminar(item._id || item.id)" class="text-neutral-500 hover:text-red-500 hover:bg-red-500/10 p-2 rounded transition-colors" title="Eliminar">
