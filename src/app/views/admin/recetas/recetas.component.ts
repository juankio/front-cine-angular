                ...
                @for (item of recetas(); track item._id || item.id) {
                  <tr class="hover:bg-muted/30 transition-colors border-b border-border group">
                    ...
                    <td class="p-4 text-center">
                      <button (click)="eliminar(item._id || item.id)" class="text-muted-foreground hover:text-primary hover:bg-primary/10 p-2 rounded transition-colors opacity-0 group-hover:opacity-100" title="Eliminar receta">
