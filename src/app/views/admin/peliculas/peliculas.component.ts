                ...
                @for (row of peliculas(); track row._id || row.id) {
                  <tr class="hover:bg-muted/30 transition-colors border-b border-border/30 group">
                    ...
                    <td class="p-4 text-right">
                      <button (click)="editar(row)" class="text-neutral-500 hover:text-blue-500 hover:bg-blue-500/10 p-2 rounded transition-colors opacity-0 group-hover:opacity-100 mr-2" title="Editar película">
                      ...
                      <button (click)="eliminar(row._id || row.id)" class="text-neutral-500 hover:text-red-500 hover:bg-red-500/10 p-2 rounded transition-colors opacity-0 group-hover:opacity-100" title="Eliminar película">
